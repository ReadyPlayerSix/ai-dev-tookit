#!/usr/bin/env python3
"""
Install Integrated MCP Server to Claude Desktop

This script installs the integrated server to Claude Desktop,
replacing the separate AI Librarian and File System servers.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Install Integrated MCP Server to Claude Desktop")
...
def main():
    ...
    server_config = {
        ...
        "args": [
            os.path.join(project_root, "launch_integrated_server.py"),
            "--name", args.name
        ],
        "env": env_vars
    }
    ...
    try:
        ...
        print(f"✅ Successfully installed integrated server as '{server_name}'.")
        if removed_servers:
