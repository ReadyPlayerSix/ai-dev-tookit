#!/usr/bin/env python3
"""
Installation script for AI Librarian with Claude Desktop
"""
import os
import json
import sys
...
def install_to_claude_desktop():
    """Install the AI Librarian to Claude Desktop config"""
    ...
    print("\nAI Librarian Installation")
    print("====================================")
    print("\nThis will install the AI Librarian to Claude Desktop.")
    ...
    librarian_script = current_dir / "launch_librarian.py"
    
    config["mcpServers"]["ai-librarian"] = {
        "command": sys.executable,
        "args": [str(librarian_script)] + all_dirs,
        "env": {}
    }
    ...
    print(f"\nSuccessfully installed AI Librarian to Claude Desktop")
